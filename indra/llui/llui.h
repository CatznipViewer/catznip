...
// [SL:KB] - Patch: Settings-ControlSLApp | Checked: 2015-07-04 (Catznip-3.7)
	LLControlVariable* getControl(const std::string& controlname);
// [/SL:KB]
...
// [SL:KB] - Patch: Chat-ChicletBarAligment | Checked: 2012-02-18 (Catznip-3.2)
	void positionViewNearMouse(LLView* view,	const LLRect& rctConstrain, S32 spawn_x = S32_MAX, S32 spawn_y = S32_MAX);
// [/SL:KB]
