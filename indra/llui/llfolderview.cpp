...
// [SL:KB] - Patch: Settings-Cached | Checked: 2013-10-07 (Catznip-3.6)
	static LLCachedControl<S32> s_fMaxVisible(*LLUI::sSettingGroups["config"], "FilterItemsMaxTimePerFrameVisible");
	static LLCachedControl<S32> s_fMaxUnvisible(*LLUI::sSettingGroups["config"], "FilterItemsMaxTimePerFrameUnvisible");
// [/SL:KB]
