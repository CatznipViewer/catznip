...
// [SL:KB] - Patch: Chat-NearbyToastWidth | Checked: 2010-08-27 (Catznip-3.2.0a)
...
// [SL:KB] - Patch: Chat-NearbyToastWidth | Checked: 2010-08-27 (Catznip-3.2.0a) | Added: Catznip-2.1.2a
...
// [SL:KB] - Patch: Chat-NearbyToastWidth | Checked: 2010-11-10 (Catznip-3.2.0a) | Modified: Catznip-2.4.0a
S32 LLNearbyChatScreenChannel::getToastWidth()
{
	...
	if (0 == snToastWidth)					// Follow the width of the nearby chat bar
	{
		...
		if (pChatBar)
		{
			...
			LLRect rctChatBar = pChatBar->getChatBox()->getRect();
