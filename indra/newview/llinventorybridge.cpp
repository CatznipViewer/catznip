...
//		const LLInventoryItem *item = model->getItem(item_id);
		...
		if (item)
		{
// [SL:KB] - Patch: Inventory-Links | Checked: 2010-04-12 (Catznip-2.1.2a) | Added: Catznip-2.0.0a
			// Can't copy worn objects. DEV-15183 [see P-JIRA: http://jira.secondlife.com/browse/VWR-6110]
			// TODO-Catznip: [SL-2.0.2] I don't think preventing copying worn items would prevent the bug that actually occurred?
			//   -> keep it the way it is for now and look into it later
...
// [SL:KB] - Patch: Inventory-Links | Checked: 2010-06-01 (Catznip-2.1.2a) | Added: Catznip-2.0.1a
