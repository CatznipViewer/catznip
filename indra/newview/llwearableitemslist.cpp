...
// [SL:KB] - Patch: Inventory-IconMismatch | Checked: 2011-05-31 (Catznip-2.6)
	setIconImage(LLInventoryIcon::getIcon(LLAssetType::AT_CLOTHING, LLInventoryType::IT_NONE, mWearableType));
// [/SL:KB]
...
void LLWearableItemsList::ContextMenuBase::show(LLView* spawning_view, LLWearableType::EType w_type, S32 x, S32 y)
{
	mParent = dynamic_cast<LLWearableItemsList*>(spawning_view);
...
// static
void LLWearableItemsList::ContextMenuBase::createNewWearableByType(LLWearableType::EType type)
{
