...
// [SL:KB] - Patch: Viewer-OptimizationSkinningMatrix | Checked: Catznip-6.4
void dump_avatar_and_skin_state(const std::string& reason, const LLVOAvatar *avatar, const LLMeshSkinInfo *skin)
// [/SL:KB]
{
#if DEBUG_SKINNING
