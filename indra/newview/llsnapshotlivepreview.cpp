...
void LLSnapshotLivePreview::saveLocal(bool prompt_path, const LLViewerWindow::save_image_callback_t& success_cb, const LLViewerWindow::save_image_callback_t& failure_cb)
// [/SL:KB]
{
    // Update mFormattedImage if necessary
    getFormattedImage();
...
// [SL:KB] - Patch: Settings-Snapshot | Checked: Catznip-3.2
	gViewerWindow->saveImage(mFormattedImage, success_cb, failure_cb, prompt_path);
// [/SL:KB]
