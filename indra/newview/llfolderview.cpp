...
void LLFolderView::openSelectedItems( void )
{
	if(getVisible() && getEnabled())
	{
// [SL:KB] - Patch: Inventory-MultiAction | Checked: 2010-04-15 (Catznip-3.0.0a) | Added: Catznip-2.0.0a
...
BOOL LLFolderView::handleKeyHere( KEY key, MASK mask )
{
	...
	case KEY_RETURN:
//		if (mask == MASK_NONE)
// [SL:KB] - Patch: Inventory-MultiAction | Checked: 2011-10-04 (Catznip-3.0.0a) | Added: Catznip-3.0.0a
...
// [SL:KB] - Patch: Inventory-MultiAction | Checked: 2010-03-29 (Catznip-3.0.0a) | Added: Catznip-2.0.0a
...
// [SL:KB] - Patch: Inventory-MultiAction | Checked: 2010-03-29 (Catznip-3.0.0a) | Modified: Catznip-2.0.0g
