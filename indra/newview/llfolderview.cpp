...
void LLFolderView::openSelectedItems( void )
{
	if(getVisible() && getEnabled())
	{
// [SL:KB] - Patch: Inventory-MultiAction | Checked: 2010-04-15 (Catznip-2.1.2a) | Added: Catznip-2.0.0a
		LLInventoryPanel* pInvPanel = dynamic_cast<LLInventoryPanel*>(mParentPanel);
		if (pInvPanel)
		{
			// NOTE: [SL-2.1.2] This is only called in response to the <enter> key being pressed on a folderview selection
...
// [SL:KB] - Patch: Inventory-MultiAction | Checked: 2010-03-29 (Catznip-2.1.2a) | Added: Catznip-2.0.0a
...
// [SL:KB] - Patch: Inventory-MultiAction | Checked: 2010-03-29 (Catznip-2.1.2a) | Modified: Catznip-2.0.0g
