...
// [SL:KB] - Patch: Settings-Cached | Checked: 2013-10-07 (Catznip-3.6)
	static LLCachedControl<bool> s_fStreamingMusic(gSavedSettings, "AudioStreamingMusic");
	static LLCachedControl<bool> s_fStreamingMedia(gSavedSettings, "AudioStreamingMedia");
