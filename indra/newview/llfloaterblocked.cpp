...
static LLRegisterPanelClassWrapper<LLPanelBlockList> t_panel_blocked_list("panel_block_list");
...
static LLRegisterPanelClassWrapper<LLPanelDerenderList> t_panel_derender_list("panel_derender_list");
