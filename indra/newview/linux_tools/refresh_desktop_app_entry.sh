...
Exec=${installation_prefix}/catznip\n\
Icon=${installation_prefix}/catznip_icon.png\n\
Terminal=false\n\
Type=Application\n\
...
X-Desktop-File-Install-Version=3.0"
    ...
    echo -e $desktop_entry > "${desktop_entries_dir}/catznip-viewer.desktop" || "Failed to install application menu!"
}
