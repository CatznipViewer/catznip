...
#include "llagent.h"
// [SL:KB] - Patch: Agent-DisplayNames | Checked: 2010-11-13 (Catznip-3.0.0a)
...
// [SL:KB] - Patch: Agent-DisplayNames | Checked: 2010-11-13 (Catznip-3.0.0a) | Added: Catznip-2.4.0a
		...
		if (LLAvatarNameCache::get(p.avatar_id, &avName))
			mMessage->appendText(avName.mDisplayName, FALSE, style_params);
		else
			mMessage->appendText(p.from, FALSE, style_params);
// [/SL:KB]
