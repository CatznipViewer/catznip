...
// [SL:KB] - Patch: DisplayNames-AgentLinkShowUsernames | Checked: 2010-11-08 (Catznip-2.3.0a) | Added: Catznip-2.3.0a
bool handleAgentLinkUsernamesChanged(const LLSD& newvalue)
{
	U32 value = newvalue.asInteger();
	LLUrlEntryAgent::setShowUsername((LLUrlEntryAgent::EShowUsername)value);
	return true;
}
// [/SL:KB]
...
// [SL:KB] - Patch: DisplayNames-AgentLinkShowUsernames | Checked: 2010-11-08 (Catznip-2.3.0a) | Added: Catznip-2.3.0a
	...
	// TODO-Catznip: find a better place to set this value initially
	handleAgentLinkUsernamesChanged(gSavedSettings.getControl("AgentLinkShowUsernames")->get());
// [/SL:KB]
