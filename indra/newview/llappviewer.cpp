...
// [SL:KB] - Patch: Settings-Misc | Checked: Catznip: 5.2
    info["RENDER_QUALITY"] = (F32)(gSavedSettings.getU32("RenderQualityPerformance") + 1);
// [/SL:KB]
...
// [RLVa:KB] - Checked: 2014-02-24 (RLVa-1.4.10)
		if (RlvActions::canShowLocation())
			...
			support << "\n\n" << LLTrans::getString("AboutPositionRLVShowLoc", args);
// [/RLVa:KB]
//		support << "\n\n" << LLTrans::getString("AboutPosition", args, default_string);
	}
...
// [SL:KB] - Patch: Viewer-HomeLastScreen | Checked: 2013-12-14 (Catznip-3.6)
		gViewerWindow->saveSnapshot(getLastScreenPath(), gViewerWindow->getWindowWidthRaw(), gViewerWindow->getWindowHeightRaw(), FALSE, TRUE);
// [/SL:KB]
