...
// [SL:KB] - Patch: UI-ProfileFloaters | Checked: 2010-11-28 (Catznip-2.5.0a) | Added: Catznip-2.4.0g
...
// [SL:KB] - Patch: UI-ProfileFloaters | Modified: 2010-11-07 (Catznip-2.5.0a) | Modified: Catznip-2.3.0a
	LLFloater* pParentView = dynamic_cast<LLFloater*>(getParent());
	if (pParentView)
