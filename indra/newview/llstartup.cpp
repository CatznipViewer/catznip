...
// [RLVa:KB] - Checked: 2010-02-27 (RLVa-1.2.0a) | Modified: RLVa-0.2.1d
		if ( (gSavedSettings.controlExists(RlvSettingNames::Main)) && (gSavedSettings.getBOOL(RlvSettingNames::Main)) )
		{
...
// [SL:KB] - Patch: Agent-LinkShowUsernames | Checked: 2011-04-17 (Catznip-2.6)
	cache_inst->setShowUsername((EShowUsername)gSavedSettings.getU32("AgentLinkShowUsernames"));
// [/SL:KB]
