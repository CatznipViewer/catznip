...
// [SL:KB] - Patch: Control-FilePicker | Checked: 2013-03-14 (Catznip-3.4)
	LLFilePicker::getOpenFile(LLFilePicker::FFLOAD_XML, boost::bind(&LLPanelPreferenceAutoReplaceSettings::loadListFromFile, this, _1));
// [/SL:KB]
...
// [SL:KB] - Patch: Control-FilePicker | Checked: 2013-03-14 (Catznip-3.4)
void LLPanelPreferenceAutoReplaceSettings::loadListFromFile(const std::string& filename)
// [/SL:KB]
{
	llifstream file;
// [SL:KB] - Patch: Control-FilePicker | Checked: 2013-03-14 (Catznip-3.4)
...
// [SL:KB] - Patch: Control-FilePicker | Checked: 2013-03-14 (Catznip-3.4)
	LLFilePicker::getSaveFile(LLFilePicker::FFSAVE_XML, listFileName,  boost::bind(&LLPanelPreferenceAutoReplaceSettings::saveListToFile, this, _1, listName));
// [/SL:KB]
...
// [SL:KB] - Patch: Control-FilePicker | Checked: 2013-03-14 (Catznip-3.4)
void LLPanelPreferenceAutoReplaceSettings::saveListToFile(const std::string& filename, std::string listName)
// [/SL:KB]
{
	llofstream file;
