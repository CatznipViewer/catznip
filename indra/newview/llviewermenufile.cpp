...
{
public:
	LLSingleUploadFilePicker(LLFilePicker::ELoadFilter eFilter, const std::string& strFloater)
		: LLFilePickerThread(eFilter), m_eFilter(eFilter), m_strFloater(strFloater)
	{
	}
...
// [SL:KB] - Patch: Inventory-Upload | Checked: 2012-04-01 (Catznip-3.3.0) | Added: Catznip-3.3.0
		...
		if (!filename.empty())
			LLFloaterReg::showInstance(m_strFloater, LLSD(filename));
	}
...
// [SL:KB] - Patch: Inventory-Upload | Checked: 2012-04-01 (Catznip-3.3.0) | Added: Catznip-3.3.0
		...
		(new LLSingleUploadFilePicker(LLFilePicker::FFLOAD_IMAGE, "upload_image"))->getFile();
// [/SL:KB]
...
// [SL:KB] - Patch: Inventory-Upload | Checked: 2012-04-01 (Catznip-3.3.0) | Added: Catznip-3.3.0
		...
		(new LLSingleUploadFilePicker(LLFilePicker::FFLOAD_WAV, "upload_sound"))->getFile();
// [/SL:KB]
...
// [SL:KB] - Patch: Inventory-Upload | Checked: 2012-04-01 (Catznip-3.3.0) | Added: Catznip-3.3.0
		...
		(new LLSingleUploadFilePicker(LLFilePicker::FFLOAD_ANIM, "upload_anim"))->getFile();
// [/SL:KB]
