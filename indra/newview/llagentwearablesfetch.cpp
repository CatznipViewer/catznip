...
{
	bool fSuccess = false;
	LL_INFOS() << "Attempting to wear library outfit '" << strOutfit << "' as the initial outfit" << LL_ENDL;
...
{
	LL_INFOS() << "Library outfit contents were fetched successfully" << LL_ENDL;
...
{
	LL_INFOS() << "Library outfit contents were successfully copied to the user's inventory" << LL_ENDL;
...
{
	LL_INFOS() << "Encountered an error while attempting to wear the initial library outfit. Creating default wearables instead." << LL_ENDL;
