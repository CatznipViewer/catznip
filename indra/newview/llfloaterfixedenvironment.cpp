...
// [SL:KB] - Patch: Control-FilePicker | Checked: Catznip-6.4
void LLFloaterFixedEnvironmentWater::loadWaterSettingFromFile(const std::string& filename)
// [/SL:KB]
{
    LLSD messages;
...
// [SL:KB] - Patch: Control-FilePicker | Checked: Catznip-6.4
void LLFloaterFixedEnvironmentSky::loadSkySettingFromFile(const std::string& filename)
// [/SL:KB]
{
//    if (filenames.size() < 1) return;
//    std::string filename = filenames[0];
