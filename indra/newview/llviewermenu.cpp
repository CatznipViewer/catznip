...
// [SL:KB] - Patch: UI-BuildEdit | Checked: 2011-10-07 (Catznip-3.0)
	...
	if (pObj)
	{
		...
		{
			LLViewerParcelMgr::getInstance()->setHoverParcel(pObj->getPositionGlobal());
		}
	}
// [/SL:KB]
//	BOOL can_build = FALSE;
...
// [/RLVa:KB]
	...
	if(category_id.notNull())
	{
		...
		if(category_id.notNull())
		{
			...
			// [SL:KB] - Allow taking rezzed items back into Received Items
			//// check inbox
