...
// [SL:KB] - Patch: Viewer-FullscreenWindow | Checked: 2010-04-13 (Catznip-2.0.0)
	/*virtual*/ BOOL getFullscreenWindow() { return FALSE; };
	/*virtual*/ void setFullscreenWindow(BOOL fFullscreen) {};
// [/SL:KB]
	/*virtual*/ BOOL getPosition(LLCoordScreen *position);
// [SL:KB] - Patch: Viewer-FullscreenWindow | Checked: 2010-08-26 (Catznip-2.1.2)
	/*virtual*/ BOOL getRestoredPosition(LLCoordScreen *position) { return getPosition(position); };
// [/SL:KB]
	/*virtual*/ BOOL getSize(LLCoordScreen *size);
	/*virtual*/ BOOL getSize(LLCoordWindow *size);
// [SL:KB] - Patch: Viewer-FullscreenWindow | Checked: 2010-08-26 (Catznip-2.1.2)
	/*virtual*/ BOOL getRestoredSize(LLCoordScreen *size) { return getSize(size); };
// [/SL:KB]
